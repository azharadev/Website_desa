	...
	function simpan_surat(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_surat->simpan_surat($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat,$photo);
					...
					$this->m_surat->simpan_surat_tanpa_img($nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat);
					echo $this->session->set_flashdata('msg','success');
					redirect('admin/surat');
				}
	...
	function update_surat(){
	            ...
	            if(!empty($_FILES['filefoto']['name']))
	            {
	                if ($this->upload->do_upload('filefoto'))
	                {
							...
							$this->m_surat->update_surat($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat,$photo);
	                    ...
	                    redirect('admin/surat');
							...
							$tgl_lahir=strip_tags($this->input->post('xtgl_lahir'));
							$alamat=strip_tags($this->input->post('xalamat'));
							$this->m_surat->update_surat_tanpa_img($kode,$nip,$nama,$jenkel,$tmp_lahir,$tgl_lahir,$alamat);
							echo $this->session->set_flashdata('msg','info');
							redirect('admin/surat');
	            } 
