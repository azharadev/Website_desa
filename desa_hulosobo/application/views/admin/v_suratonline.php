...
<?php
error_reporting(0);
$query = $this->db->query("SELECT * FROM tbl_suratonline WHERE surat_status='1'");
...
<body class="hold-transition skin-blue sidebar-mini">
                    ...
                    <div class="col-xs-12">
                        ...
                        <div class="box">
                            <div class="box-header">
                                ...
                                <a href="<?php echo base_url('admin/surat/export') ?>" class="btn btn-danger btn-flat"><span class="fa fa-print"></span> Export PDF</a>

                                <a href="<?php echo base_url('admin/surat/export_ex') ?>" class="btn btn-success btn-flat"><span class="fa fa-print"></span> Export Excel</a>
                                ...
                                <table id="example1" class="table table-striped" style="font-size:12px;">
                                    ...
                                    <tbody>
                                        ...
                                        foreach ($data->result_array() as $i) :
                                            $no++;
                                            $surat_nik = $i['surat_nik'];
                                            $surat_nama = $i['surat_nama'];
                                            $surat_email = $i['surat_email'];
                                            $surat_msg = $i['surat_pesan'];
                                            $tanggal = $i['tanggal'];

                                        ?>
                                            <tr>
                                                <td><?php echo $tanggal; ?></td>
                                                <td><?php echo $surat_nama; ?></td>
                                                <td><?php echo $surat_email; ?></td>
                                                <td><?php echo $surat_msg; ?></td>
                                                <td style="text-align:right;">
                                                    <a class="btn" data-toggle="modal" data-target="#ModalHapus<?php echo $surat_nik; ?>"><span class="fa fa-trash"></span></a>
                                                </td>
                                            </tr>
                                        <?php endforeach; ?>
                                    </tbody>
    ...
    ?>
        ...
        <div class="modal fade" id="ModalHapus<?php echo $surat_id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
            <div class="modal-dialog" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true"><span class="fa fa-close"></span></span></button>
                    ...
                    <form class="form-horizontal" action="<?php echo base_url() . 'admin/surat/hapus_surat' ?>" method="post" enctype="multipart/form-data">
                        <div class="modal-body">
                            <input type="hidden" name="kode" value="<?php echo $surat_id; ?>" />
