...
<body class="hold-transition skin-blue sidebar-mini">
  <div class="wrapper">
      ...
      <section class="sidebar">
        ...
        <ul class="sidebar-menu">
          ...
          <li class="treeview">
            ...
            <ul class="treeview-menu">
              <li><a href="<?php echo base_url() . 'admin/surat' ?>"><i class="fa fa-users"></i> Data Surat</a></li>
              <li><a href="#"><i class="fa fa-star-o"></i> Prestasi Surat</a></li>
    ...
    <footer class="main-footer">
      ...
      <strong>Copyright &copy; 2020 <a href="http://">Devi Anindia Putri</a>.</strong> All rights reserved.
    </footer>
