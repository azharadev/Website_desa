          ...
          <div class="col-xs-12">
            ...
            <div class="box">
              <div class="box-header">
                ...
                <a href="<?php echo base_url('admin/inbox/export') ?>" class="btn btn-danger btn-flat"><span class="fa fa-print"></span> Export PDF</a>

                <a href="<?php echo base_url('admin/inbox/export_ex') ?>" class="btn btn-success btn-flat"><span class="fa fa-print"></span> Export Excel</a>
