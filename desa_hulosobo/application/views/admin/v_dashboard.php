...
<head>
  ...
  <title>Hulosobo | Dashboard</title>
      ...
      <section class="content">
        ...
        <div class="row">
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-purworejo bg-aqua"><i class="fa fa-chrome"></i></span>
              <?php
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-purworejo bg-red"><i class="fa fa-firefox"></i></span>
              <?php
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-purworejo bg-green"><i class="fa fa-bug"></i></span>
              <?php
          ...
          <div class="col-md-3 col-sm-6 col-xs-12">
            <div class="info-box">
              <span class="info-box-purworejo bg-yellow"><i class="fa fa-opera"></i></span>
              <?php
        ...
        <div class="row">
          ...
          <div class="col-md-4">
            ...
            <div class="info-box bg-yellow">
              <span class="info-box-purworejo"><i class="fa fa-safari"></i></span>
              <?php
            ...
            <div class="info-box bg-green">
              <span class="info-box-purworejo"><i class="fa fa-globe"></i></span>
              <?php
            ...
            <div class="info-box bg-red">
              <span class="info-box-purworejo"><i class="fa fa-users"></i></span>
              <?php
