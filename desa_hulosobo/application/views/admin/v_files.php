            ...
            <div class="box">
              ...
              <div class="box">
                <div class="box-header">
                  <a class="btn btn-primary btn-flat" data-toggle="modal" data-target="#myModal"><span class="fa fa-plus"></span> Add File</a>
                  <a href="<?php echo base_url('admin/files/export_ex') ?>" class="btn btn-success btn-flat"><span class="fa fa-print"></span> Export Excel</a>
                </div>
                <!-- /.box-header -->
                <div class="box-body">
