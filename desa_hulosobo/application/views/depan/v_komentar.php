...
<body>
            ...
            <div class="row">
                <div class="col-xs-6 col-sm-8 col-md-9">
                    ...
                    <div class="header-top_login2">
                        <a href="<?php echo site_url('komentar'); ?>">Hubungi Kami</a>
                    </div>
                </div>
            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url(''); ?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="50px;" src="<?php echo base_url() . 'theme/images/logo_desa1.pngg' ?>"></a>
                        <div class="collapse navbar-collapse justify-content-end" id="navbarNavDropdown">
                            <ul class="navbar-nav">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('penduduk'); ?>">Penduduk</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('surat'); ?>">Surat</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('blog'); ?>">Berita</a>
                                </li>
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('laporan'); ?>">Laporan</a>
                                </li>
                                <li class="nav-item">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="<?php echo site_url('komentar'); ?>">Layanan</a>
                                </li>
                            </ul>
                        </div>
                    </nav>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="komentar-form">
                        <div class="row">
                            <div class="col-xs-12 col-sm-12 col-md-6 komentar-option">
                                <div class="komentar-option_rsp">
                                    <h3>Tinggalkan Pesan</h3>
                                    <form action="<?php echo site_url('komentar/kirim_pesan'); ?>" method="post">
                                        ...
                                        <!-- // end #js-komentar-result -->
                                    </form>
                                </div>
                            </div>
                            <div class="col-xs-12 col-sm-12 col-md-6">
                                <div class="komentar-address">
                                    <h3>Lokasi</h3>
                                    <div class="komentar-details">
                ...
                <div class="col-md-3">
                    <div class="sitemap">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('komentar'); ?>">Layanan</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3">
    ...
    <script src="<?php echo base_url() . 'theme/js/komentar.js' ?>"></script>
    <!-- Script JS -->
