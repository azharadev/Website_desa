...
<body>
    ...
    <section class="events">
        <div class="container">
            <div class="row">
                <div class="col-md-4">
                    <h2 class="event-title">Laporan</h2>
                </div>
                <div class="col-md-8">
                    <!-- Nav tabs -->
                    <ul class="nav nav-tabs" role="tablist">
                        <li class="nav-item nav-tab1">
                            <a class="nav-link tab-list active" data-toggle="tab" href="#upcoming-events" role="tab">Laporan Terbaru </a>
                        </li>
                                ...
                                <div class="row">
                                    <div class="col-md-2">
                                        <div class="event-date">
                                            <h4><?php echo date("d", strtotime($row->laporan_tanggal)); ?></h4> <span><?php echo date("M Y", strtotime($row->laporan_tanggal)); ?></span>
                                        </div>
                                        <span class="event-time"><?php echo date("H:i", strtotime($row->laporan_tanggal)) . ' WIB'; ?></span>
                                    </div>
                                    <div class="col-md-10">
                                        <div class="event-heading">
                                            <h3><?php echo $row->laporan_judul; ?></h3>
                                            <p><?php echo $row->laporan_deskripsi; ?></p>
                                        </div>
                                    </div>
                                </div>
                ...
                <div class="col-md-3">
                    <div class="sitemap">
                        ...
                        <ul>
                            ...
                            <li><a href="<?php echo site_url('contact'); ?>">Layanan</a></li>
                        </ul>
                    </div>
                </div>
                <div class="col-md-3">
