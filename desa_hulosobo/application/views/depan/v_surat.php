            ...
            <div class="row">
                <div class="col-md-12">
                    <nav class="navbar navbar2 navbar-toggleable-md navbar-light bg-faded">
                        ...
                        <a href="<?php echo site_url(''); ?>" class="navbar-brand nav-brand2"><img class="img img-responsive" width="50px;" src="<?php echo base_url() . 'theme/images/logo_desa1.png' ?>"></a>
                ...
                <?php foreach ($data->result() as $row) : ?>
                    <div class="col-xs-12 col-sm-6 col-md-3">
                        <div class="admission_insruction">
                            <?php if (empty($row->penduduk_photo)) : ?>
                                <!-- <img src="<?php echo base_url() . 'assets/images/blank.png'; ?>" class="img-fluid" alt="#"> -->
                            <?php else : ?>
                                <!-- <img src="<?php echo base_url() . 'assets/images/' . $row->surat_photo; ?>" class="img-fluid" alt="#"> -->
                            <?php endif; ?>
                            <p class="text-center mt-3"><span><?php echo $row->surat_nama; ?></span>
                                <br>
                                <?php echo $row->surat_alamat; ?></p>
                        </div>
                    </div>
                <?php endforeach; ?>
            </div>
